...
// Inicializa el array
    for(int contador = 0; contador < N; contador++) {
      Gestisimal.articulos[contador] = new Articulo();
    }
...
// Comprueba que el código introducido no se repita
            ...
            articulos[Buscarhueco()] = new Articulo(
        ...
        System.out.print("BAJA");
          ...
          if (!existe(codigoIntroducido)) {
            ...
            articulos[localizar(codigoIntroducido)].setCodigo("LIBRE");
        ...
        System.out.print("MODIFICACIÓN");
          ...
          if (!existe(codigoIntroducido)) {
            ...
            System.out.println("Precio de compra: " + articulos[i].getPrecioTotal());
            System.out.print("Nuevo precio de compra: ");
            String precioDeCompraIntroducidoString = s.nextLine();
            if (!precioDeCompraIntroducidoString.equals("")) {
              articulos[i].setPrecioTotal(Double.parseDouble(precioDeCompraIntroducidoString));
            }
            ...
            System.out.println("Stock: " + articulos[i].getalmacen());
            System.out.print("Nuevo stock: ");
            String stockIntroducidoString = s.nextLine();
            if (!stockIntroducidoString.equals("")) {
              articulos[i].setalmacen(Integer.parseInt(stockIntroducidoString));
            }
          }
          ...
          System.out.print("ENTRADA DE MERCANCÍA");
            ...
            if (!existe(codigoIntroducido)) {
              ...
              articulos[i].setalmacen(
                Integer.parseInt(cantidadString) + articulos[i].getalmacen());
            ...
            System.out.print("SALIDA DE MERCANCÍA");
              ...
              if (!existe(codigoIntroducido)) {
                ...
                cantidad = Integer.parseInt(s.nextLine());
                if (articulos[i].getalmacen() - cantidad > 0) {
                  articulos[i].setalmacen(articulos[i].getalmacen() - cantidad);
